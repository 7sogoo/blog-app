...
const imageURLS = ["https://s3-alpha-sig.figma.com/img/3abf/26dd/585632b9d05dcfd0daffacedd55842f5?Expires=1722211200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=PGaAS6boAe1jt7IE16J3AhBdS4oh-R64BcF71O~vpOVG45MXQ7Mz7kbSES0YcMtROk1bQJg5lD7Pey3sJaXn5N0QP0fleDa~h1h-~K0XVSFWWPSjIBV6GKQSbgDnVSDkPYjP3Gr4aInjtgZDc2KCGSP2L2kBUlsGQC9pz1eGLEsP821zltTv3G2QLm-qzI6oY7Uq8qKIoCDXS7UJnDSqSXSNEH2ssjK0TKRWbHpUkzG5fHO8-EUqCqIPZkyRpsDVVKkCLUWMk8rwjpCpqsqity7ufQz2SmZUDB-69xb44sZWpSjPIySFeYq8VZPpMlUj6tLEvHw7PEsv71o5OCRp6Q__",
    ...
    "https://s3-alpha-sig.figma.com/img/fd32/a56d/d484b871abb15e732abb0a69f2ccd525?Expires=1722211200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=TvAb~4j1sPoNpZphDIOLanQv6HQgXkY~Jm3Xp6U3DTmrZC5Pn3zzYeNRzdoBajFrSozP-0W5zYFqc7ticVMrtq8Qzq45YW9Uk15sGMpTrXojeWAajnOkxcErUBYkhthMsPgNz6r-VWW0ZbDTil~SFng62eBcw-W~0~g03coYkdqCceJwjdRZ3xuu1LoGRhoZQCjLJ~6WO82X~px27EN31aZvbrj1sHikWowLRQE0Z67jU2NYhfjLeDt8zzZKaM09mYJdbM3y1ogeluQuvRec15NHSEv-9Oq1rzKwUPz1jCynvvUD~L9DAR2BUoM~t1fN~Izp9o4I7aK1r3kBUNKqdg__",
    "https://s3-alpha-sig.figma.com/img/348e/c9c1/94d6445161ab63109e6e813699b61984?Expires=1722211200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=fAzRO0UFEWE9aluhJwQq90QNQz-RtqIoHHQJ2IvjsA10gsQQiWVG~XYeV2MuWWDERRViHPVX62LfuJqic6LDxNcypzVh03b5MzVQsIqf87Pp0rAUSOYv5V8s0iOFKiysRtS4j6shr~EjFfXbiy74pI4OLh8s4qNIUp8dXWPaHLPLcSBSLDeoeVgpbmyA~x6drx~bEnXXn76O~p9mdMyQ-sWkn0kH66PWXg4VeObyMI6nd0cw9zoFBdt75O9WMHfrAcV-~2hBamWJPZCiDvEpL2AQSvOlMEi~hpgn4FRCBB42sqizTuG3yPEyQl7gVQZRcrJ6Np5JkK9FmMKhxZALCA__",
    ...
    "https://s3-alpha-sig.figma.com/img/3087/05a3/0ba138a3797a763d4510333166532abb?Expires=1722211200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=GmsmKKEHnenEpystHkvhASFM3LtgGXfrtnCOwOiy7gfaCaN0Fvj5BKbVIfKLudYCcAlxyoN1BaBQOuGOvoptkf6TqZvKhrUK8xQTcMivF2iRXe6-EIfRipaM7Cz-fMw-b42KQ2S9Vvm55Er0CWh53cPGBGJcBfr5YfLg8ffMAsMcKLBO0LMLm5mXLH33iIo3Pdn0NnqVtHsZJCSEoaVxn8ruERIovOSvI-jCuTA~gVIPt2Fx9geHhpeXWOTaiEVuwTjCo1Y9Pap1u1D5HYyWlqUj7JFA4a3qNorWgMNrcU03ZkfN2fznWKglf0KKyGT9Zy3OY4QXaJ0slrbXVqm23g__",
...
export const Posts = () => {
    return(
        <div className="px-[350px] py-[100px]">
            <div>
                <div className="mb-10"><PostHeader/></div>
                <div className="flex-wrap flex gap-[20px] max-w-[100%]">{imageURLS.map((el,i) => (
                    <PostCardCreator key={i} url={el}/>
                ))}</div>
                <div className="flex items-center justify-center mt-20 mb-[10px]">
                    <button className="px-5 py-3 border-[1px] border-[#00000050] text-[#696A75] rounded-lg">Load More</button>
                </div>
            </div>
        </div>
    )
